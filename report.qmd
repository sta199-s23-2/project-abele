...
In summary, we were only able to obtain conclusive results regarding how one of our explanatory variables is a predictor for our response variable, perceived threat level. Age returned statistically significant results, whereas race and location (United States region) did not. Based on our predict function, perceived threat level consistently and steadily increased as age increased, from 3.58574 at age 25, to 3.605667 at age 35, to 3.625595 at age 45. This depicts that age is positively correlated with perceived threat level, proving our previous hypothesis about their relationship to be correct. Conversely, perceived threat level was fairly constant across race and regions, leaving us with no clear answer to how these variables predict threat level. 
